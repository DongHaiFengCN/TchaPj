...
public class TaskDyMainActivity_ViewBinding implements Unbinder {
  private TaskDyMainActivity target;

  @UiThread
  public TaskDyMainActivity_ViewBinding(TaskDyMainActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public TaskDyMainActivity_ViewBinding(TaskDyMainActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TaskDyMainActivity target = this.target;
