...
public class ConsultationInfoAdapter$SudokuViewHolder_ViewBinding implements Unbinder {
  private ConsultationInfoAdapter.SudokuViewHolder target;

  @UiThread
  public ConsultationInfoAdapter$SudokuViewHolder_ViewBinding(ConsultationInfoAdapter.SudokuViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ConsultationInfoAdapter.SudokuViewHolder target = this.target;
