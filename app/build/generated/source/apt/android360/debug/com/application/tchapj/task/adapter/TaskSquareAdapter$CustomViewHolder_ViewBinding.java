...
public class TaskSquareAdapter$CustomViewHolder_ViewBinding implements Unbinder {
  private TaskSquareAdapter.CustomViewHolder target;

  @UiThread
  public TaskSquareAdapter$CustomViewHolder_ViewBinding(TaskSquareAdapter.CustomViewHolder target, View source) {
    this.target = target;

    target.task_ll = Utils.findRequiredViewAsType(source, R.id.task_ll, "field 'task_ll'", LinearLayout.class);
  ...
  @CallSuper
  public void unbind() {
    TaskSquareAdapter.CustomViewHolder target = this.target;
