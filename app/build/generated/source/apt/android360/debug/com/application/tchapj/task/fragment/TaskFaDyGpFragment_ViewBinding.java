...
public class TaskFaDyGpFragment_ViewBinding implements Unbinder {
  private TaskFaDyGpFragment target;

  @UiThread
  public TaskFaDyGpFragment_ViewBinding(TaskFaDyGpFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TaskFaDyGpFragment target = this.target;
