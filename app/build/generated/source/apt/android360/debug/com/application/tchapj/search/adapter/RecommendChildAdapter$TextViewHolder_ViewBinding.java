...
public class RecommendChildAdapter$TextViewHolder_ViewBinding implements Unbinder {
  private RecommendChildAdapter.TextViewHolder target;

  @UiThread
  public RecommendChildAdapter$TextViewHolder_ViewBinding(RecommendChildAdapter.TextViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RecommendChildAdapter.TextViewHolder target = this.target;
