...
public class TaskFaDyYcFragment_ViewBinding implements Unbinder {
  private TaskFaDyYcFragment target;

  @UiThread
  public TaskFaDyYcFragment_ViewBinding(TaskFaDyYcFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TaskFaDyYcFragment target = this.target;
