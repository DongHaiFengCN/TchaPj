...
public class MyTaskSquareAdapter$CustomViewHolder_ViewBinding implements Unbinder {
  private MyTaskSquareAdapter.CustomViewHolder target;

  @UiThread
  public MyTaskSquareAdapter$CustomViewHolder_ViewBinding(MyTaskSquareAdapter.CustomViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MyTaskSquareAdapter.CustomViewHolder target = this.target;
