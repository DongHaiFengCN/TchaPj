...
public class TaskSquareDyGpActivity_ViewBinding implements Unbinder {
  private TaskSquareDyGpActivity target;
  ...
  @UiThread
  public TaskSquareDyGpActivity_ViewBinding(TaskSquareDyGpActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public TaskSquareDyGpActivity_ViewBinding(final TaskSquareDyGpActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TaskSquareDyGpActivity target = this.target;
