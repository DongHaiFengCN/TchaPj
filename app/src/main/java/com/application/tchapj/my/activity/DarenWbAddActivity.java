...
public class DarenWbAddActivity extends BaseMvpActivity<IDarenOneView, DarenOnePresenter> implements IDarenOneView
    ...
    @BindView(R.id.wb_add_ncet)
    EditText wb_add_ncet;
    @BindView(R.id.wb_add_bjet)
    EditText wb_add_bjet;
    @BindView(R.id.wb_add_rv)
    RecyclerView wb_add_rv;
    @BindView(R.id.wb_add_bt)
    Button wb_add_bt;
    ...
    protected void initToolbar(ToolbarHelper toolbarHelper) {
        ...
        toolbarHelper.setTitle("添加微博资料");
    }

    @Override
    public int getRootViewId() {
        return R.layout.activity_wb_add;
    }
    ...
    public void initUI() {
        ...
        adapter = new ImagePickerAdapter(DarenWbAddActivity.this, selImageList, maxImgCount);
        adapter.setOnItemClickListener(this);

        initImagePicker();
        initWidget();

        wb_add_bt.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void initWidget() {
        ...
        wb_add_rv.setLayoutManager(new GridLayoutManager(DarenWbAddActivity.this, 1));
        wb_add_rv.setHasFixedSize(true);
        wb_add_rv.setAdapter(adapter);
    }
    ...
    public void onItemClick(View view, int position) {
        switch (position) {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        switch (position) {
                            case 0: // 直接调起相机
                                ...
                                Intent intent = new Intent(DarenWbAddActivity.this, ImageGridActivity.class);
                            ...
                            case 1:
                                //打开选择,本次允许选择的数量
                                ImagePicker.getInstance().setSelectLimit(maxImgCount - selImageList.size());
                                Intent intent1 = new Intent(DarenWbAddActivity.this, ImageGridActivity.class);
            ...
            default:
                //打开预览
                Intent intentPreview = new Intent(DarenWbAddActivity.this, ImagePreviewDelActivity.class);
    ...
    private SelectDialog showDialog(SelectDialog.SelectDialogListener listener, List<String> names) {
        SelectDialog dialog = new SelectDialog(DarenWbAddActivity.this, R.style
                .transparentFrameWindowStyle,
                listener, names);
        if (!DarenWbAddActivity.this.isFinishing()) {
            dialog.show();
        }
        return dialog;
    }
...
// 重用uploadManager。一般地，只需要创建一个uploadManager对象
    ...
    public void onViewClicked() {
        ...
        CommonDialogUtil.showExampleImgDialog(this, "1");
    }
