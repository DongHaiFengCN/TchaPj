...
public class ImagePickerAdapter2 extends RecyclerView.Adapter<ImagePickerAdapter2.SelectedPicViewHolder> {
    ...
    public ImagePickerAdapter2(Context mContext, List<ImageItem> data, int maxImgCount) {
    ...
    public SelectedPicViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SelectedPicViewHolder(mInflater.inflate(R.layout.list_item_image2, parent, false));
    }
    ...
    public class SelectedPicViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(int position) {
            ...
            if (isAdded && position == getItemCount() - 1) {
                ...
                clickPosition = MingrenActivity.IMAGE_ITEM_ADD; // 重点修改
            } else {
