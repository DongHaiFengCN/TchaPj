...
public class DarenDyAddActivity extends BaseMvpActivity<IDarenOneView, DarenOnePresenter> implements IDarenOneView, ImagePickerAdapter.OnRecyclerViewItemClickListener{

    @BindView(R.id.dy_add_fset)
    EditText dy_add_fset;
    @BindView(R.id.dy_add_ncet)
    EditText dy_add_ncet;
    @BindView(R.id.dy_add_blet)
    EditText dy_add_blet;
    @BindView(R.id.dy_add_plet)
    EditText dy_add_plet;
    @BindView(R.id.dy_add_zlet)
    EditText dy_add_zlet;
    @BindView(R.id.dy_add_et)
    EditText dy_add_et;
    @BindView(R.id.dy_add_rv)
    RecyclerView dy_add_rv;
    @BindView(R.id.dy_add_tv)
    Button dy_add_tv;
    ...
    protected void initToolbar(ToolbarHelper toolbarHelper) {
        ...
        toolbarHelper.setTitle("添加抖音资料");
    }

    @Override
    public int getRootViewId() {
        return R.layout.activity_dy_add;
    }
    ...
    public void initUI() {
        ...
        adapter = new ImagePickerAdapter(DarenDyAddActivity.this, selImageList, maxImgCount);
        adapter.setOnItemClickListener(this);

        initImagePicker();
        initWidget();

        dy_add_tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                nickName = dy_add_ncet.getText().toString();
                price = dy_add_et.getText().toString();
    ...
    public void onGetDarenDataBeanResult(DarenDataBean darenDataBean) {
        ...
        if ("000".equals(darenDataBean.getCode())) {
            ...
            Toast.makeText(DarenDyAddActivity.this,"提交成功",Toast.LENGTH_LONG).show();
            finish();
        }
    ...
    private void initWidget() {
        ...
        dy_add_rv.setLayoutManager(new GridLayoutManager(DarenDyAddActivity.this, 1));
        dy_add_rv.setHasFixedSize(true);
        dy_add_rv.setAdapter(adapter);
    }
    ...
    public void onItemClick(View view, int position) {
        switch (position) {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        switch (position) {
                            case 0: // 直接调起相机
                                ...
                                Intent intent = new Intent(DarenDyAddActivity.this, ImageGridActivity.class);
                            ...
                            case 1:
                                //打开选择,本次允许选择的数量
                                ImagePicker.getInstance().setSelectLimit(maxImgCount - selImageList.size());
                                Intent intent1 = new Intent(DarenDyAddActivity.this, ImageGridActivity.class);
            ...
            default:
                //打开预览
                Intent intentPreview = new Intent(DarenDyAddActivity.this, ImagePreviewDelActivity.class);
    ...
    private SelectDialog showDialog(SelectDialog.SelectDialogListener listener, List<String> names) {
        SelectDialog dialog = new SelectDialog(DarenDyAddActivity.this, R.style
                .transparentFrameWindowStyle,
                listener, names);
        if (!DarenDyAddActivity.this.isFinishing()) {
            dialog.show();
        }
        return dialog;
    }
...
// 重用uploadManager。一般地，只需要创建一个uploadManager对象
    ...
    @OnClick(R.id.dy_add_example_tv)
    public void onViewClicked() {
        CommonDialogUtil.showExampleImgDialog(this, "2");
    }
