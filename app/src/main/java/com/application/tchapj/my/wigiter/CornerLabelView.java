...
public class CornerLabelView extends View {
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        mText1.height = ta.getDimension(R.styleable.CornerLabelView_clvText1Height, dp2px(13));
        ...
        mText2.height = ta.getDimension(R.styleable.CornerLabelView_clvText2Height, dp2px(11));
