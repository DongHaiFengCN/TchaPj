package com.application.tchapj.utils2.channeltagview.view;
...
import com.application.tchapj.utils2.channeltagview.util.MeasureUtil;
...
public class ChannelTagView extends LinearLayout {
    ...
    public ChannelTagView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        // 背景色
        categoryAddedBannerBg = array.getResourceId(R.styleable.channel_tag_style_addedCategroyTitleBg, R.color.page_bg);
        // 背景色
        categoryUnAddedBannerBg = array.getResourceId(R.styleable.channel_tag_style_unAddedCategroyTitleBg, R.color.page_bg);
        ...
        fixedPos2 = array.getInt(R.styleable.channel_tag_style_fixedPos2, -1);
    ...
    private void init() {
        ...
        itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.Callback() {
            ...
            public boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder target) {
                ...
                if (from == fixedPos || from == fixedPos2) {
                    return false;
                }
                if (to == fixedPos|| from == fixedPos2) {
                    return false;
                }
...
//                }
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                if (position != fixedPos && position != fixedPos2) {
            ...
            public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
                ...
                if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE && position != fixedPos && position != fixedPos2) {
            ...
            public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
                ...
                if (viewHolder.getAdapterPosition() == fixedPos || viewHolder.getAdapterPosition() == fixedPos2) {
    ...
    private class ChannelAdapter extends CommonAdapter<ChannelItem> {
        ...
        protected void convert(ViewHolder holder, ChannelItem channelItem, final int position) {
            ...
            if (isAddedChannel && fixedPos == position || fixedPos2 == position) {
    ...
    public void setFixedPos2(int fixedPos2) {
        this.fixedPos2 = fixedPos2;
    }
