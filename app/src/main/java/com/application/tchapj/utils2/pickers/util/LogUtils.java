package com.application.tchapj.utils2.pickers.util;
...
public final class LogUtils {
    ...
    private static boolean isDebug = Constants.IS_DEBUG;// 是否调试模式
    private static String debugTag = Constants.DEBUG_TAG;// LogCat的标记
