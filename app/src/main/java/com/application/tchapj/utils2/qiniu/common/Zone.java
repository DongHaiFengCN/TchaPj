package com.application.tchapj.utils2.qiniu.common;
 ...
 */
public abstract class Zone extends com.qiniu.android.common.Zone {
    /**
     * 获取上传域名
     */
    ...
    @Override
    public void preQuery(String token, com.qiniu.android.common.Zone.QueryHandler complete) {
