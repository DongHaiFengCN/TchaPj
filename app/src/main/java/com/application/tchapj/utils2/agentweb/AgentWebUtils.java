...
import static com.application.tchapj.utils2.agentweb.AgentWebConfig.AGENTWEB_FILE_PATH;
import static com.application.tchapj.utils2.agentweb.AgentWebConfig.FILE_CACHE_PATH;
...
//            ignore.printStackTrace();
	...
	static boolean showFileChooserCompat(Activity activity,
		...
		try {
			...
			Class<?> clz = Class.forName("filechooser.FileChooser");
