...
import com.application.tchapj.utils2.imagepicker.adapter.ImagePageAdapter;
...
import com.application.tchapj.utils2.imagepicker.view.ViewPagerFixed;
...
public abstract class ImagePreviewBaseActivity extends ImageBaseActivity {
    ...
    protected ArrayList<String> mImageUrlItems;      //url
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isFromItems) {
            ...
            mImageUrlItems = (ArrayList<String>) getIntent().getSerializableExtra(ImagePicker.EXTRA_IMAGE_URL_ITEMS);
        } else {
            // 下面采用弱引用会导致预览崩溃
