...
public class ImagePreviewDelActivity extends ImagePreviewBaseActivity implements View.OnClickListener {
    ...
    private void showDeleteDialog() {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                mImageUrlItems.remove(mCurrentPosition);
                mDeletePosition = mCurrentPosition;
    ...
    public void onBackPressed() {
        ...
        intent.putExtra(ImagePicker.EXTRA_IMAGE_URL_ITEMS, mImageUrlItems);
        intent.putExtra(ImagePicker.EXTRA_IMAGE_DELETE_ITEMS, mDeletePosition);
