package com.application.tchapj.utils2.pickers.picker;
...
import com.application.tchapj.utils2.pickers.adapter.ArrayWheelAdapter;
...
import com.application.tchapj.utils2.pickers.util.DateUtils;
import com.application.tchapj.utils2.pickers.util.LogUtils;
import com.application.tchapj.utils2.pickers.widget.WheelListView;
...
public class DateTimePicker extends WheelPicker {
    ...
    private int startYear = Calendar.getInstance().get(Calendar.YEAR), startMonth = Calendar.getInstance().get(Calendar.MONTH) + 1, startDay = Calendar.getInstance().get(Calendar.DATE);
    private int endYear = startYear + 50, endMonth = startMonth, endDay = 31;
    private int startHour = startMinute = Calendar.getInstance().get(Calendar.HOUR_OF_DAY), startMinute = Calendar.getInstance().get(Calendar.MINUTE);
