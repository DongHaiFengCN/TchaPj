...
public interface UserActionListener {
     ...
     */
     void onMoved(int fromPos, int toPos, ArrayList<ChannelItem> addedChannels);
     ...
     */
    void onSwiped(int position, View itemView, ArrayList<ChannelItem> addedChannels, ArrayList<ChannelItem> unAddedChannels);
