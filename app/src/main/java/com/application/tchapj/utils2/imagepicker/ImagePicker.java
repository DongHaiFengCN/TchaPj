package com.application.tchapj.utils2.imagepicker;
...
import com.application.tchapj.utils2.imagepicker.util.ProviderUtil;
...
public class ImagePicker {
    ...
    public static final String EXTRA_IMAGE_URL_ITEMS = "EXTRA_IMAGE_URL_ITEMS";
    public static final String EXTRA_IMAGE_DELETE_ITEMS = "EXTRA_IMAGE_DELETE_ITEMS";//删除图片的下标
