...
*/
    ...
    // 指定应用分享
    public static void showShare(Context context, String shareTitle, String content, String imgUrl, String webUrl, String platformName) {
        ...
        // 网页地址。titleUrl是标题的网络链接，仅在Linked-in,QQ和QQ空间使用
        oks.setTitleUrl(webUrl);
        // text是分享文本，所有平台都需要这个字段
        oks.setText(content);
        // 分享小图。分享网络图片，新浪微博分享网络图片需要通过审核后申请高级写入接口，否则请注释掉测试新浪微博
