...
public class CourseTableView extends RelativeLayout {
    ...
    // 课程格子的背景图2
    private static final int[] COURSE_BG2 = {R.drawable.course_info_light_blue2, R.drawable.course_info_green2,
    ...
    public interface OnCourseItemClickListener {
        void onCourseItemClick(TextView tv, int jieci, int day, String des, String CourseName, String TeachPlace, String TeachDate, String Section, String TeachName);
    }
    ...
    private void updateCourseViews() {
        ...
        for (final Course c : coursesData) {
            ...
            tv.setLines(7);
            tv.getText();
            tv.setBackgroundResource(COURSE_BG[(int) (Math.random() * 6)]);
            ...
            tv.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onCourseItemClickListener != null)
                        onCourseItemClickListener.onCourseItemClick((TextView) v, jieci, day, c.getDes(),c.getCourseName(),c.getTeachPlace(),c.getTeachDate(),c.getSection(),c.getTeachName());
                }
            });
    ...
    private void initFirstTv() {
        ...
        firstTv.setText( c.get(Calendar.MONTH) + 1+"月");
        ...
        firstTv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 16);
        firstTv.setPadding(oneW, 0, oneW, twoW);
    ...
    private void initRestTv() {
        ...
        for (int i = 0; i < totalDay; i++) {
            ...
            tvDay.setPadding(twoW, twoW, twoW, twoW * 2);
            ...
            if (US_DAYS_NUMS[todayNum] - 1 == i) {
                tvDate.setBackgroundDrawable(getResources().getDrawable(R.drawable.checked_bg2));
            }
