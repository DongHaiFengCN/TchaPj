...
import com.application.tchapj.bean.SqqShape;


// 滑动开关工具类
public class SlideSwitch extends View implements ValueAnimator.AnimatorUpdateListener {
	...
	private float spotX;
	/** 开启颜色*/
	private int onColor = Color.parseColor("#29a1f7");
	/** 关闭颜色 */
