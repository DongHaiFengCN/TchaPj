...
import com.application.tchapj.bean.WeekBean;

import java.util.List;


// 自定义Spinner实体类不同
public class CommonSpinner2 <T> extends TextView implements View.OnClickListener{
    ...
    public CommonSpinner2(Context context) {
        this(context, null);
    }

    public CommonSpinner2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CommonSpinner2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    class SpinnerPopupWindow extends PopupWindow {
        ...
        class MyAdapter extends BaseAdapter {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                ...
                if(bean instanceof WeekBean.WeekData){
                    final WeekBean.WeekData beanT = (WeekBean.WeekData) bean;

                    bt.setText("第"+beanT.getWeek()+"周");
                    bt.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            showPopupWindow(mTvTopView);

                            mTvTopView.setText("第"+beanT.getWeek()+"周");
