...
public class TaskFaWsYcFragment extends BaseMvpFragment<IFaTaskView, FaTaskPresenter> implements IFaTaskView, ImagePickerAdapter.OnRecyclerViewItemClickListener{
...
//    private String circleTypeId;// 投放圈子
    ...
    // 接收参数
    public static TaskFaWsYcFragment newInstance(String param) {
        Bundle args = new Bundle();
        args.putString("args", param);
        TaskFaWsYcFragment fragment = new TaskFaWsYcFragment();
...
//        picker.setStepMinute(5);
        ...
        fa_dyyc_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                taskType = "7";      // 0 朋友圈 1 微博 2 抖音合拍 3 抖音原创 4其他
