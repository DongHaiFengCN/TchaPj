 ...
 * data：16/7/27
 */
public class NewGridImageAdapter extends
        RecyclerView.Adapter<NewGridImageAdapter.ViewHolder> {
    ...
    public NewGridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.drawable.updatevideo);
