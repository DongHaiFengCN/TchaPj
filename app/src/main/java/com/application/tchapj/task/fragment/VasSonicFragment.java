...
import com.application.tchapj.task.sonic.SonicImpl;
import com.application.tchapj.task.sonic.SonicJavaScriptInterface;
...
public class VasSonicFragment extends AgentWebFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAgentWeb.getJsInterfaceHolder()
                .addJavaObject("sonic", new SonicJavaScriptInterface(mSonicImpl.getSonicSessionClient(), new Intent().putExtra(PARAM_CLICK_TIME,getArguments().getLong(PARAM_CLICK_TIME))
