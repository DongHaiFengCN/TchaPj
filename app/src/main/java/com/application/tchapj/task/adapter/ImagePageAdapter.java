...
public class ImagePageAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (TextUtils.equals(imageItem.mimeType, "copy")) {
            GlideUtils.loadImageView(mActivity, imageItem.path, photoView, R.color.gainsboro);
        } else {
        ...
        photoView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (photoViewLongClickListener != null) {
                    photoViewLongClickListener.OnPhotoLongClick();
                }
                return false;
            }
        });
