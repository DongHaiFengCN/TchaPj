...
// 发抖音任务
public class TaskDyMainActivity extends BaseActvity {
    ...
    public void initUI() {
        ...
        fragments.add(new TaskFaDyGpFragment());
        fragments.add(new TaskFaDyYcFragment());
