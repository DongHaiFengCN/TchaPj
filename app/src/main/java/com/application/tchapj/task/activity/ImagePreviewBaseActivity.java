...
import com.application.tchapj.task.adapter.ImagePageAdapter;
...
import com.application.tchapj.utils2.imagepicker.ui.ImageBaseActivity;
...
public abstract class ImagePreviewBaseActivity extends ImageBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setPhotoViewLongClickListener(new ImagePageAdapter.PhotoViewLongClickListener() {
            @Override
