...
public class CircularProgressDrawable extends Drawable {
     ...
     * show a 90潞 arc which will be spinning around the outer circle as much as progress goes.
     */
    ...
    public void draw(Canvas canvas) {
		...
		textPaint.getTextBounds(faceText, 0, faceText.length(), textBounds);  
	    FontMetricsInt fontMetrics = paint.getFontMetricsInt();
	    int baseline = (bounds.height() - fontMetrics.bottom + fontMetrics.top) / 2 - fontMetrics.top;  
	    canvas.drawText(faceText,bounds.width() / 2 - textBounds.width() / 2, baseline, textPaint);  	  
    }
     ...
     * <p/>
     * Otherwise the drawable will enter "loading mode" and a 90潞 arc will be able to be spinned around
     * the inner circle.
     * <p/>
